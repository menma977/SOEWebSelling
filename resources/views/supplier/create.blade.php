              ...
              <div class="col-md-10 mx-auto">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-6 col-md-6">
                    ...
                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="_phone" value="{{ old('phone') }}">
                    @error('phone')
                    <div class="alert alert-danger" role="alert">
                      {{ $message }}
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="_address" value="{{ old('address') }}">
                  @error('address')
                  <div class="alert alert-danger" role="alert">
                    {{ $message }}
                  </div>
